...
#ifdef OWN_PAD
#define CHEST_RK_POWER_ON_DELAY_TIME       2000/SYSTICK_PERIOD   //1s
#define CHEST_RK_POWER_OFF_DELAY_TIME      1000/SYSTICK_PERIOD   //1s
#define CHEST_RK_POWER_ON_HOLD_TIME        4000/SYSTICK_PERIOD   //5s
#define CHEST_RK_POWER_OFF_HOLD_TIME       5000/SYSTICK_PERIOD   //5s
#define CHEST_RK_POWER_ON_PROCESSING_TIME  30000/SYSTICK_PERIOD   //30s
#define CHEST_RK_POWER_OFF_PROCESSING_TIME 20000/SYSTICK_PERIOD   //20s
#else
#define CHEST_RK_POWER_ON_DELAY_TIME       1000/SYSTICK_PERIOD   //1s
#define CHEST_RK_POWER_OFF_DELAY_TIME      1000/SYSTICK_PERIOD   //1s
#define CHEST_RK_POWER_ON_HOLD_TIME        5000/SYSTICK_PERIOD   //5s
#define CHEST_RK_POWER_OFF_HOLD_TIME       1000/SYSTICK_PERIOD   //1s
#define CHEST_RK_POWER_ON_PROCESSING_TIME  15000/SYSTICK_PERIOD   //15s
#define CHEST_RK_POWER_OFF_PROCESSING_TIME 10000/SYSTICK_PERIOD   //10s
#endif
...
#ifdef OWN_PAD
#define HEAD_RK_POWER_ON_DELAY_TIME       4000/SYSTICK_PERIOD   //1s
#define HEAD_RK_POWER_OFF_DELAY_TIME      1000/SYSTICK_PERIOD   //1s
#define HEAD_RK_POWER_ON_HOLD_TIME        4000/SYSTICK_PERIOD   //4s
#define HEAD_RK_POWER_OFF_HOLD_TIME       5000/SYSTICK_PERIOD   //5s
#define HEAD_RK_POWER_ON_PROCESSING_TIME  30000/SYSTICK_PERIOD   //30s
#define HEAD_RK_POWER_OFF_PROCESSING_TIME 20000/SYSTICK_PERIOD   //20s
#else
#define HEAD_RK_POWER_ON_DELAY_TIME       1000/SYSTICK_PERIOD   //1s
#define HEAD_RK_POWER_OFF_DELAY_TIME      1000/SYSTICK_PERIOD   //1s
#define HEAD_RK_POWER_ON_HOLD_TIME        1000/SYSTICK_PERIOD   //1s
#define HEAD_RK_POWER_OFF_HOLD_TIME       6000/SYSTICK_PERIOD   //6s
#define HEAD_RK_POWER_ON_PROCESSING_TIME  15000/SYSTICK_PERIOD   //15s
#define HEAD_RK_POWER_OFF_PROCESSING_TIME 20000/SYSTICK_PERIOD   //20s
#endif
...
#define     MODULE_HEAD_RK      1
#define     MODULE_CHEST_RK     2
...
extern controlSignal_t *chest_rk_control_signal;
extern controlSignal_t *head_rk_control_signal;

extern void PowerOffDevices( uint8_t select );
extern void PowerOnDevices( uint8_t select );
